...
def estimate_transform(left_list, right_list, fix_scale = False):
    ...
    for l, r in zip(left_list, right_list):
        ...
        l_r = (l[0] - lc[0], l[1] - lc[1])
        r_r = (r[0] - lc[0], r[1] - lc[1])
        l_red.append(l_r)  # create list of tuples containing reduced coordinates of each cylinder in left_list
        r_red.append(r_r) # create list of tuples containing reduced coordinate of each cylinder in right_list
