...
def astar(start, goal, obstacles):
    ...
    #   to the front.
    start_cost = distance(start, goal)
    front = [ (start_cost, 0.001, start, None) ]
    ...
    while front:
        ...
        for dx, dy, deltacost in movements:
            ...
            if not visited[new_pos] and obstacles[new_pos] != 255:
                heappush(front, (cost+deltacost+distance(new_pos, goal)+obstacles[new_pos]/64, cost+deltacost+obstacles[new_pos]/64, new_pos, pos))
